...
public class ChatBot_VINAdapter extends RecyclerView.Adapter<ChatBot_VINAdapter.MessageViewHolder> {
    private List<ChatBot_VINMessage> messages;
    private Context context;

    public ChatBot_VINAdapter(Context context) {
        this.messages = new ArrayList<>();
        this.context = context;
    }

    public ChatBot_VINAdapter() {
        this.messages = new ArrayList<>();
    }

    public void addMessage(ChatBot_VINMessage message) {
    ...
    public MessageViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_message_vin, parent, false);
        return new MessageViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MessageViewHolder holder, int position) {
        ChatBot_VINMessage message = messages.get(position);
    ...
    private void customizeTextStyle(MessageViewHolder holder, String sender) {
        try {
            ...
            } else if ("ChatBot_VinPrincipal".equals(sender)) {
