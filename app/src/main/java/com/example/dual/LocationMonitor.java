...
public class LocationMonitor implements LocationListener {
    ...
    public LocationMonitor(com.example.dual.Activity_RecorridoGeorreferenciado mainActivity) {
        this.Activity_RecorridoGeorreferenciado = Activity_RecorridoGeorreferenciado;
